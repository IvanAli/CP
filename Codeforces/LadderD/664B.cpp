...
<head>
    ...
    <meta name="X-Csrf-Token" content="2290cf0469af3bd306101faa68db01dd"/>
    ...
    <meta property="og:title" content="Submission #17382301 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d3c8a44afb27abc915a5c56cb94270752eece7d6"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17382301 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2290cf0469af3bd306101faa68db01dd'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2290cf0469af3bd306101faa68db01dd'/>
...
<a href="/profile/IvanAli" title="Pupil IvanAli" class="rated-user user-green">IvanAli</a>    </td>
    <td>
        <a title="B - Rebus" href="/contest/664/problem/B">664B</a>
...
int main() {
    getline(cin, s);
    int pos = s.find("=");
    nstr = s.substr(pos + 2, s.size() - pos - 2);
    n = 0;
    ...
    int minval, maxval;
    minval = plusop - n * minusop;
    maxval = n * plusop - minusop;
    if (n < minval || n > maxval) cout << "Impossible" << endl;
    else {
        cout << "Possible" << endl;
        int sum = 0;
        for (int i = 0; i < op.size(); i++) {
            ...
            if (op[i] == 1) plusop--;
            else if (op[i] == -1) minusop--;
            for (int j = 1; j <= n; j++) {
                minval = sum + j * op[i] + plusop - n * minusop;
                maxval = sum + j * op[i] + n * plusop - minusop;
