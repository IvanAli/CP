...
<head>
    ...
    <meta name="X-Csrf-Token" content="453f2e966c5fde3492c05222cde7a5fa"/>
    ...
    <meta property="og:title" content="Submission #15472867 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f01affe3ae49d8dcf2090fad0174bcf1429a7efb"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15472867 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='453f2e966c5fde3492c05222cde7a5fa'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='453f2e966c5fde3492c05222cde7a5fa'/>
...
<a href="/profile/IvanAli" title="Newbie IvanAli" class="rated-user user-gray">IvanAli</a>    </td>
    <td>
        <a title="B - Grandfather Dovlets calculator" href="/contest/620/problem/B">620B</a>
    ...
    <td>2016-01-21 18:14:31</td>
    <td>2016-01-22 20:55:21</td>
    <td>
    ...
    <pre class="prettyprint program-source" style="padding: 0.5em;">#include <cstdio>
...
int segments[] = {zero, one, two, three, four, five, six, seven, eight, nine};

int processDigit(int n) {
    int ans = 0;
    while (n) {
        ans += (segments[n % 10]);
        n /= 10;
