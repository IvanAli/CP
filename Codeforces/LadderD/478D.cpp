...
<head>
    ...
    <meta name="X-Csrf-Token" content="5055a9cb3fcc68faf5f4671b3091375b"/>
    ...
    <meta property="og:title" content="Submission #19229503 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="42f65585a7a5efaaec6baa3cd9360c6bbe90e457"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19229503 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5055a9cb3fcc68faf5f4671b3091375b'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5055a9cb3fcc68faf5f4671b3091375b'/>
...
<a href="/profile/IvanAli" title="Pupil IvanAli" class="rated-user user-green">IvanAli</a>    </td>
    <td>
        <a title="D - Red-Green Towers" href="/contest/478/problem/D">478D</a>
...
int main() {
    ...
    for (int i = 1; i <= h; i++) for (int j = r; j >= 0; j--)
    dp[j] = (dp[j] + (i <= j ? dp[j - i] : 0)) % mod;
    int ans = 0;
    for (int i = 0; i <= r; i++) if (((h * h + h) >> 1) - i <= g) ans = (ans + dp[i]) % mod;
    cout << ans << endl;
    return 0;
}
