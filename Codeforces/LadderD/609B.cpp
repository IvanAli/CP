...
<head>
    ...
    <meta name="X-Csrf-Token" content="c45f4cb5b75931092d18ab8b0d52fcca"/>
    ...
    <meta property="og:title" content="Submission #14888292 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="7bbccdee9cdb34efd187f8101334f9fea6a9dcdb"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14888292 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c45f4cb5b75931092d18ab8b0d52fcca'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c45f4cb5b75931092d18ab8b0d52fcca'/>
...
<a href="/profile/IvanAli" title="Newbie IvanAli" class="rated-user user-gray">IvanAli</a>    </td>
    <td>
        <a title="B - The Best Gift" href="/contest/609/problem/B">609B</a>
    ...
    <td>2015-12-19 19:59:07</td>
    <td>2015-12-20 21:35:23</td>
    <td>
...
int main() {
    ...
    for (int i = 1; i <= m; i++) {
        if (bucket[i] > 1)
            repeated += (long long)((bucket[i] * (bucket[i] - 1) / 2));
    }
    ans -= repeated;
    cout << ans << endl;
    return 0;
