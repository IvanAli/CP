...
<head>
    ...
    <meta name="X-Csrf-Token" content="48ee6ba62807a1de658502a6eb3eb319"/>
    ...
    <meta property="og:title" content="Submission #19268743 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="4e3314eb837e548af732bb54edba9397a5d5fea3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19268743 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='48ee6ba62807a1de658502a6eb3eb319'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='48ee6ba62807a1de658502a6eb3eb319'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/375">Problems</a></li>
        <li><a
                                        href="/contest/375/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/375/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/375/status">Status</a></li>
        <li><a
                                        href="/contest/375/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/375/room/1">Room</a></li>
        <li><a
                                        href="/contest/375/standings">Standings</a></li>
        <li><a
                                        href="/contest/375/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/IvanAli" title="Pupil IvanAli" class="rated-user user-green">IvanAli</a>    </td>
    <td>
        <a title="B - Maximum Submatrix 2" href="/contest/375/problem/B">375B</a>
...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        cin >> s;
        for (int j = m - 1; j >= 0; j--) {
            if (s[j] - 0) dp[i][j] = dp[i][j + 1], dp[i][j]++;
        }
    }
    int ans = 0;
    for (int i = 0; i < m; i++) {
        for (int j = 0; j <= m; j++) b[j] = 0;
        for (int j = 0; j < n; j++) b[dp[j][i]]++;
        for (int j = m; j >= 0; j--) b[j] += b[j + 1];
        for (int j = 0; j <= m; j++) ans = max(ans, j * b[j]);
    }
    cout << ans << endl;
    return 0;
}
