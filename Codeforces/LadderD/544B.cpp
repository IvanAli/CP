...
<head>
    ...
    <meta name="X-Csrf-Token" content="7aad452b72d38c074ed99b561fd85349"/>
    ...
    <meta property="og:title" content="Submission #11035971 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="817dfb880313f65a893bb8599bb028be3ee8c312"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11035971 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7aad452b72d38c074ed99b561fd85349'></span>
...
<div id="header" style="position: relative;">
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7aad452b72d38c074ed99b561fd85349'/>
...
<a href="/profile/IvanAli" title="Pupil IvanAli" class="rated-user user-green">IvanAli</a>    </td>
    ...
    <pre class="prettyprint program-source" style="padding: 0.5em;">#include <stdio.h>
#include <iostream>
#include <string>
#include <cmath>
    ...
    if((n * n) % 2 == 0) {
        ...
        for(int i = 0; i < n; i++) {
            for(int j = 0; j < n; j++) {
                ...
                if(grid[i][left] == S && grid[i][right] == S &&
                        grid[up][j] == S && grid[down][j] == S) {
                    if(islandNumber < k) {
                        grid[i][j] = L;
                        islandNumber++;
                    }
